    ...
    internal sealed class UpdateManagedObjectHandler : ToolHandlerBase
    {
        ...
        public override ToolDefinition Definition => ToolHandlerUtilities.CreateDefinition(
            ...
            new JObject
            {
                ...
                ["explanationHint"] = "For full update/delete semantics and dependency-order rules use GetExplanationContent('explaining_edit_and_delete'). Hard rule for test/generator work: before writing FlowBloxTestDefinition and/or generation-strategy related structures, first load GetExplanationContent('explaining_test_definitions') and GetExplanationContent('explaining_generators').",
