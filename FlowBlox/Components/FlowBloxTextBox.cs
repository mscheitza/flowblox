...
namespace FlowBlox.Components
{
    public class FlowBloxTextBox : Panel
    {
        ...
        private void ResizeTimer_Tick(object sender, EventArgs e)
        {
            if (needsUpdate)
            {
                textBoxContainer.ResumeLayout();
                textBoxContainer.PerformLayout();
                textBoxContainer.SuspendLayout();
                needsUpdate = false;
            }
        }
        ...
        {
            resizing = true;
            lastPoint = PointToClient(Cursor.Position);
            textBoxContainer.SuspendLayout();
            resizeTimer.Start();
        }
        ...
        {
            textBox.Font = new Font("JetBrains Mono", 8f, FontStyle.Regular);
            textBox.Tag = FlowBloxStyleTags.StyleKeepFont;
        }
