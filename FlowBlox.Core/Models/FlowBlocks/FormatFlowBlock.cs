...
namespace FlowBlox.Core.Models.FlowBlocks
{
    ...
    public class FormatFlowBlock : BaseSingleResultFlowBlock
    {
        ...
        {
            this.FormatParameterDefinitions = new ObservableCollection<FormatParameterDefinition>();
        }
        ...
        public override bool Execute(Runtime.BaseRuntime runtime, object data)
        {
            return base.Invoke(runtime, data, () =>
            {
                ...
                object[] parameters = this.FormatParameterDefinitions.Select(x => x.Field.Value).ToArray();
