...
{
    [Display(Name = "Phi2AiTokenizer_DisplayName", Description = "Phi2AiTokenizer_Description", ResourceType = typeof(FlowBloxTexts))]
    public class Phi2AiTokenizer : AiTokenizerBase
    {
        ...
        [Display(Name = "Phi2AiTokenizer_TokenizerConfiguration", ResourceType = typeof(FlowBloxTexts), Order = 1)]
        ...
        public override void Initialize()
        {
            ...
            {
                var vocabStream = File.OpenRead(vocabFile);
                var mergesStream = File.OpenRead(mergesFile);

                return Phi2Tokenizer.Create(vocabStream, mergesStream);
            });
