...
namespace FlowBlox.Core.Models.FlowBlocks.Persistence
{
    ...
    public class ExecuteSQLFlowBlock : BaseFlowBlock
    {
        ...
        [FlowBloxUI(Factory = UIFactory.Default, UiOptions = UIOptions.EnableFieldSelection, ToolboxCategory = nameof(FlowBloxToolboxCategory.SQL))]
        [FlowBloxTextBox(IsCodingMode = true, MultiLine = true, SyntaxHighlighting = "FlowBlox.UICore.Resources.Highlighting.SQL.xshd")]
        [Required]
        ...
        public int ExecuteSQL(DbTypes dbType, string sqlConnectionstring, string sqlStatement)
        {
            ...
            if (dbConnection != null)
            {
                ...
                sqlStatement = FlowBloxFieldHelper.ReplaceFieldsInSQL(sqlStatement, DbType, out parameters);
